...
namespace ExtensionToContentTypeHelper
{
    public class ExtensionToContentTypeHelper
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                if (choice == 1)
                {
                    ...
                    Console.WriteLine(helper.GetContentTypeByExtension(extension));
                ...
                else if (choice == 2)
                {
                    ...
                    string extension = Console.ReadLine();
                    Console.WriteLine(helper.GetExtensionByContentType(extension));
                    Console.WriteLine("\t Press Any Key To Continue");
                    Console.ReadKey();
                }
